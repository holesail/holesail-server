...
server2.serve({port:45000, address:"0.0.0.0",udp:true, buffSeed: "2656e7cbe15a7acb64b4158b76ea76eaa2715e05e14d76cd4f3da333cb361750"}, () => {
    console.log('UDP server started');
    console.log(server1.getPublicKey());
    setTimeout(() => {
      server1.destroy();
      console.log('Server 2 destroyed');
  }, 6000);
})